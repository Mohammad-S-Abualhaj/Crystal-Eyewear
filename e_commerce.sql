...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 05, 2021 at 11:53 AM
...
(4, 'sunglasses', 'sunglasses for women, men, and kids.', ''),
(5, 'eyeglasses', 'eyeglasses for women, men, and kids.', '');
...
CREATE TABLE `products` (
  ...
  `product-best-seller` tinyint(4) NOT NULL DEFAULT 0,
...
(6, 'kendaart', 'abualhaj.designer@gmail.com', '15a9bad0cf3410c3c273514159f7a768', '', '', 'momen alhamed');
...
--
ALTER TABLE `products`
  MODIFY `product_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
