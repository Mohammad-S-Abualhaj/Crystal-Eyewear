...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2021 at 05:12 PM
...
CREATE TABLE `order_summary` (
  ...
  `date_of creation` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
...
(48, 'SmartBuy Collection Skye SS-CP121E', 'SmartBuy Collection Skye sunglasses are great for any occasion. The perfect color combination  of Milky Tortoise and Smoke Grey make this pair a great addition to any outfit. Made from  Injected Plastic and with a 2 year warranty, these stylish sunglasses', 39, '24903544538_1622173969566.jpg', 0, 0, NULL, 50, 4, 2),
(49, 'SmartBuy Collection Reeses SS-915E', 'Want to update your look? Grab a pair of these fantastic SmartBuy Collection Reeses  sunglasses in Silver . Order your SmartBuy Collection Reeses sunglasses from SmartBuyGlasses  and know that you have a 24 month backed warranty.', 39, '89562544524_1622173969556.jpg', 0, 0, NULL, 0, 4, 2),
...
--
ALTER TABLE `order_summary`
  ADD CONSTRAINT `order_summary_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `user` (`id`);
COMMIT;
