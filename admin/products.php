								...
								<div class="card-header border-0 pt-6">
									<div class=card-title>
										<div class="d-flex align-items-center position-relative my-1">
											...
											<input data-kt-product-table-filter=search class="form-control form-control-solid w-250px ps-14" placeholder="Search product">
										</div>
									</div>
									<div class=card-toolbar>
										...
										<div class="d-flex justify-content-end align-items-center d-none" data-kt-product-table-toolbar=selected>
											<div class="fw-bolder me-5"><span class=me-2 data-kt-product-table-select=selected_count></span>Selected</div>
											<button type=button class="btn btn-danger" data-kt-product-table-select=delete_selected>Delete Selected</button>
										</div>
													...
													<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
														<form id=kt_modal_add_product_form class=form action=#>
															<div class="d-flex flex-column scroll-y me-n7 pe-7" id=kt_modal_add_product_scroll data-kt-scroll=true data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height=auto data-kt-scroll-dependencies=#kt_modal_add_product_header data-kt-scroll-wrappers=#kt_modal_add_product_scroll data-kt-scroll-offset=300px>
																...
																<div class="fv-row mb-7"><label class="required fw-bold fs-6 mb-2">Name</label><input name=product_name class="form-control form-control-solid mb-3 mb-lg-0" placeholder="name" value="Emma Smith"></div>
																<div class="fv-row mb-7"><label class="required fw-bold fs-6 mb-2">price</label><input type=text name=price class="form-control form-control-solid mb-3 mb-lg-0" placeholder=656$ value="656$"></div>
																<div class=mb-7>
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id=kt_table_products>
										...
										<tbody class="text-gray-600 fw-bold">
											<tr>
												...
												<td><a href=../../demo1/dist/apps/product-management/products/view.html>Emma Smith</a></td>
												<td>70$</td>
												<td>Emma</td>
												<td class="pe-0 text-end">
													...
													<a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="tooltip" title="" data-kt-products-table-filter="delete_row" data-bs-original-title="Delete">
														<span class="svg-icon svg-icon-3">
															<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
<script src="assets/js/products-table.js"></script>
