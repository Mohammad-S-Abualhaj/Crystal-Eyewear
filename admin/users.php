                                 ...
                                 <tbody class="text-gray-600 fw-bold">
                                    <tr>
                                       ...
                                       <td class="pe-0 text-end">
                                          <a href="edit/user-edit.php?id=<?php echo $user["id"]; ?>"  class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" name="edit">
                                          ...
                                          <a href="../admin/user-delete.php?id=<?php echo $user["id"]; ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" name="delete" data-bs-toggle="tooltip" title="" data-kt-delete="delete_row" data-bs-original-title="Delete">
                                             <span class="svg-icon svg-icon-3">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
