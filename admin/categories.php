...
if(isset($_POST['add_category_submit'])){
	...
	$strt=$connection->prepare("INSERT INTO category (name,description) VALUES ('{$cat_name}','{$cat_desc}')");
	$strt->execute();
								...
								<div class="card-header border-0 pt-6">
									...
									<div class=card-toolbar>
										<div class="d-flex justify-content-end" data-kt-category-table-toolbar=base>
											...
											<!-- _____________________delete buton_______________________ -->
											...
											<div class="modal-dialog modal-dialog-centered mw-650px">
												<div class=modal-content>
													...
													<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
														<form id=kt_modal_add_category_form class=form method="post">
